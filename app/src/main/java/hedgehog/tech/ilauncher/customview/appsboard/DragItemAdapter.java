...
public abstract class DragItemAdapter<T, VH extends DragItemAdapter.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    protected List<GridItemModel> mItemList;
    ...
    public void setItemList(List<GridItemModel> itemList) {
        mItemList = itemList;
        notifyDataSetChanged();
    }

    public List<GridItemModel> getItemList() {
        return mItemList;
    }
    ...
    public void addItem(int pos, GridItemModel item) {
    ...
    public void changeItemPosition(int fromPos, int toPos) {
        if (mItemList != null && mItemList.size() > fromPos && mItemList.size() > toPos) {
            GridItemModel item = mItemList.remove(fromPos);
