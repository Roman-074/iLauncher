package hedgehog.tech.ilauncher.customview.topsheet;
/*
...
public class TopSheetDialog extends AppCompatDialog {
    ...
    public TopSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        // We hide the permission_overlay_text_top bar for any style configuration. Otherwise, there will be a gap
    ...
    private View wrapInTopSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        final CoordinatorLayout coordinator = (CoordinatorLayout) View.inflate(getContext(),
                R.layout.dialog_top_sheet, null);
        if (layoutResId != 0 && view == null) {
            view = getLayoutInflater().inflate(layoutResId, coordinator, false);
        }
        FrameLayout topSheet = (FrameLayout) coordinator.findViewById(R.id.top_sheet_design);
